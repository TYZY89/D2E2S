...
class TIN(nn.Module):
    ...
    def forward(self, h_feature, h_syn_ori, h_syn_feature, h_sem_ori, h_sem_feature):
        ...
        # h_syn_origin, h_syn_feature = self.GatedGCN(h_syn_origin, h_syn_feature)
        # h_sem_origin, h_sem_feature = self.GatedGCN(h_sem_origin, h_sem_feature)
